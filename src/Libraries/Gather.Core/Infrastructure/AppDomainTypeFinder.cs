...
namespace Gather.Core.Infrastructure
{
    ...
    /// currently executing AppDomain. Only assemblies whose names match
    /// certain patterns are investigated and an optional list of assemblies
    /// references by <see cref="AssemblyNames"/> are always investigated.
    /// </summary>
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Nvc should iterate assemblies in the app domain when loading Nop types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Nvc assemblies arn't investigated (e.g. by not including something like "^Nop|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the Nvc factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into Nvc.</returns>
